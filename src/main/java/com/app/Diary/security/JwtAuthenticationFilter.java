...
// MODIFICADO: Se elimina @Component para que SecurityConfig tome el control de la creación de este bean.
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // MODIFICADO: Usamos inyección por constructor en lugar de @Autowired.
